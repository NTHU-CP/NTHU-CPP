...
- [盧錦隆計算方法設計 2021 Midterm Exam 2 Problem 4](https://drive.google.com/file/d/1UAQ8hliRH6dZk74q78cQzRWOM2Cb6i_G). 有些教科書稱為 **significant inversion pair**. 簡單說就是將原本 inversion 限制為更嚴格的 \\(i<j\land S_i>2S_j\\).
